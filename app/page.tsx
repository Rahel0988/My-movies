...
//           'https://api.airtable.com/v0/YOUR_BASE_ID/YOUR_MOVIE_TABLE_NAME?api_key=YOUR_API_KEY'
//         );
...
//       try {
//         const response = await axios.get(
//           'https://api.airtable.com/v0/YOUR_BASE_ID/Comments?api_key=YOUR_API_KEY'
//         );
